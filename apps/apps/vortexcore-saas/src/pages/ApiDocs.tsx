      ...
      <div className="container mx-auto py-16 px-4">
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Comprehensive guides and references for the VortexCore API platform.
          </p>
          ...
          <TabsContent value="getting-started" className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Get started with VortexCore API in minutes</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Sign up for a VortexCore account to get your API keys.</p>
                    ...
                    <div>
                      ...
                      <div className="mt-3 p-4 bg-secondary/50 rounded-md overflow-x-auto">
                        <pre className="text-xs text-muted-foreground">
                          <code>
{`curl -X GET "https://api.vortexcore.com/v1/bank-statements" \\
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div>
                      ...
                      <code className="text-sm bg-secondary py-1 px-2 rounded">https://api.vortexcore.com</code>
                    </div>
                    <div>
                      <div className="text-sm font-medium">Sandbox</div>
                      <code className="text-sm bg-secondary py-1 px-2 rounded">https://sandbox-api.vortexcore.com</code>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      All API requests require authentication using your API key. You can generate API keys from your VortexCore dashboard.
                    </p>
...
fetch('https://api.vortexcore.com/v1/bank-statements', {
  method: 'GET',
  headers: {
    ...
    console.error('Error:', error.message);
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    In addition to our official SDKs, the community has built several frameworks, plugins, and integrations to help you integrate VortexCore into your tech stack.
                  </p>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                      { name: 'React Hook', desc: 'React hooks for VortexCore API' },
