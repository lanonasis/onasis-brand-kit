...
if [[ -z "$SUPABASE_ANON_KEY=REDACTED_SUPABASE_ANON_KEY
...
test_webhook_endpoint() {
    ...
    local endpoint="$SUPABASE_URL=https://<project-ref>.supabase.co
...
main() {
    ...
    echo -e "${CYAN}Supabase URL: $SUPABASE_URL=https://<project-ref>.supabase.co
