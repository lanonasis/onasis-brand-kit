...
const openai = new OpenAI({
  apiKey: Deno.env.get('OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
});

// Validate that we have a valid API key
if (!Deno.env.get('OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
  console.error("CRITICAL ERROR: Missing OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
}
