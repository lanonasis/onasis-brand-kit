...
```bash
# DON'T DO THIS
apps/vortexcore/.env          # OPENAI_API_KEY=key1
apps/vortexcore-saas/.env     # OPENAI_API_KEY=key2  
apps/maple-site/.env          # OPENAI_API_KEY=key3
apps/lanonasis-index/.env     # OPENAI_API_KEY=key4
```
...
OPENAI_API_KEY=prod_key_with_billing_limits
