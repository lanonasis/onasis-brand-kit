...
const supabase = createClient(Deno.env.get("SUPABASE_URL=https://<project-ref>.supabase.co
const webhookSecret = Deno.env.get("STRIPE_WEBHOOK_SECRET=REDACTED_WEBHOOK_SECRET
serve(async (req)=>{
  try {
