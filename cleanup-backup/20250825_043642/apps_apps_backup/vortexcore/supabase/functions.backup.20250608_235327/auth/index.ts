...
serve(async (req) => {
  ...
  try {
    const supabaseUrl = Deno.env.get('SUPABASE_URL=https://<project-ref>.supabase.co
    const supabaseServiceKey = Deno.env.get('SUPABASE_SERVICE_ROLE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
