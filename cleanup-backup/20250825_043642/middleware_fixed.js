...
const ONASIS_CORE_SUPABASE_URL = process.env.ONASIS_CORE_SUPABASE_URL || 'https://lanonasis.supabase.co';
const ONASIS_CORE_SERVICE_KEY = process.env.ONASIS_CORE_SERVICE_KEY || process.env.SUPABASE_SERVICE_KEY;
...
if (!ONASIS_CORE_SERVICE_KEY) {
  throw new Error('ONASIS_CORE_SERVICE_KEY or SUPABASE_SERVICE_KEY environment variable is required but not set');
}
...
const jwtMiddleware = createJWTMiddleware({
  supabaseUrl: ONASIS_CORE_SUPABASE_URL,
