...
/**
 * Default API URL for LanOnasis services - Central Onasis-core gateway
 */
export const DEFAULT_API_URL = 'https://api.lanonasis.com/v1';
...
export const MCP_CONFIG = {
  DEFAULT_SSE_URL: 'https://api.lanonasis.com/v1/mcp/sse',
