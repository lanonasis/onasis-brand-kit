...
#### For TEST_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
...
The script will:
- Set TEST_SUPABASE_URL=https://<project-ref>.supabase.co
- Prompt you for the keys
- Generate a secure JWT_SECRET=REDACTED_JWT_SECRET
